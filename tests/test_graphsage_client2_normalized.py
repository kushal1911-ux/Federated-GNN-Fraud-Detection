# ============================================================
# RFGN CLIENT 2 NORMALIZED GRAPHSAGE FORWARD-PASS TEST
# ============================================================
...
def main():
    ...
    print()
    print("=" * 70)
    print("RFGN CLIENT 2 NORMALIZED GRAPHSAGE FORWARD-PASS TEST")
    print("=" * 70)
    ...
    print()
    print("=" * 70)
    print("CHECKING NORMALIZED CLIENT 2 GRAPH")
    print("=" * 70)
