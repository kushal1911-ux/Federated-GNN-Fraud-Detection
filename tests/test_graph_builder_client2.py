...
# ============================================================
# RFGN CLIENT 2 GRAPH BUILDER TEST
# ============================================================
...
def main():
    ...
    print()
    print("=" * 70)
    print("RFGN CLIENT 2 GRAPH BUILDER TEST")
    print("=" * 70)

    print()
    print("Building graph for Client 2 only.")
    ...
    print()
    print("=" * 70)
    print("CLIENT 2 GRAPH VALIDATION")
    print("=" * 70)

    assert data is not None
    print("Basic graph object: PASS")
    ...
    print()
    print("=" * 70)
    print("CLIENT 2 GRAPH BUILDER TEST: PASSED")
    print("=" * 70)
