# ============================================================
# RFGN - CLIENT 1 ENHANCED GRAPHSAGE TRAINING
# ============================================================
#
# Purpose:
#   Train the enhanced 3-layer residual GraphSAGE model
#   on Client 1's enhanced aligned graph.
#
# Input:
#   data/processed/graphs/client_1/graph_enhanced_aligned.pt
#
# Model:
#   EnhancedGraphSAGE
#   769 input features
...
#
# Output:
#   saved_models/local/client_1_enhanced_graphsage_best.pt
#
# ============================================================
...
METRICS_PATH = os.path.join(
    MODEL_DIR,
    "client_1_enhanced_graphsage_metrics.json",
)
...
def load_graph():
    ...
    print(
        "Loading Client 1 enhanced graph..."
    )

    # PyTorch 2.6 changed the default
    # weights_only behavior of torch.load().
    #
    # This graph is a trusted locally-generated
    # PyTorch Geometric Data object, so the complete
...
def train():
    ...
    print(
        "CLIENT 1 ENHANCED GRAPHSAGE TRAINING COMPLETE"
    )
