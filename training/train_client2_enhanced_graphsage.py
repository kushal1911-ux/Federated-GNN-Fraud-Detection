# ============================================================
# RFGN - CLIENT 2 ENHANCED GRAPHSAGE TRAINING
# ============================================================
#
# Input:
#   data/processed/graphs/client_2/graph_enhanced_aligned.pt
#
# Model:
#   EnhancedGraphSAGE
#   769 input features
...
#
# Output:
#   saved_models/local/client_2_enhanced_graphsage_best.pt
#
# ============================================================
...
METRICS_PATH = os.path.join(
    MODEL_DIR,
    "client_2_enhanced_graphsage_metrics.json",
)
...
def load_graph():
    ...
    print(
        "Loading Client 2 enhanced graph..."
    )
...
def train():
    ...
    print(
        "CLIENT 2 ENHANCED GRAPHSAGE TRAINING COMPLETE"
    )
