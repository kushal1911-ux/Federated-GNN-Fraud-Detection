# ============================================================
# RFGN CLIENT 2 LOCAL GRAPHSAGE TRAINING
# ============================================================
...
CHECKPOINT_PATH = os.path.join(
    ...
    "saved_models",
    "checkpoints",
    "client_2_graphsage_aligned_checkpoint.pt",
)
...
def main():
    ...
    section(
        "LOADING CLIENT 2 ALIGNED GRAPH"
    )
    ...
    print(
        "CLIENT 2 LOCAL GRAPHSAGE TRAINING: COMPLETE"
    )
